...
import datetime
''' the pywhatkit is commented out so that it wont depend
so much on internet for every launch'''
#import pywhatkit as kit
#from decouple import config

#USERNAME = config('JOHN')
#BOTNAME = config('QUANT STONE')
USERNAME = 'JOHN' #add your desired name 
BOTNAME = 'QUANT STONE'
...
def tellDay():
    ...
    if day in Day_dict.keys():
        ...
        m.speak("The day is " + day_of_the_week)
...
def tellTime():
  ...
  #nd then after slicing we can get time
    ...
    hour = time[11:13]
    min = time[14:16]
    m.speak( "The time is " + hour + " " + min + "Minutes")
